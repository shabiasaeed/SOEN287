...
<!-- This file is to edit an already created user
 When the edit button is clicked, the website is redirected here
the users information will be displayed in the form 
 we do this by getting the users id and using it to get the rest of its info-->
...
<!------------------------------ php functions and code----------------------->
<?php
include 'userfunctions.php';

$errors=array(); //error array to store errors
...
<div class="wrapper">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components">
            ...
            <li>
                <a href="order_list_p11.html">&#128221; Orders</a>
            </li>
            <li>
                <a href="#">&#128161; Feedback</a>
            </li>
									...
									<div class="card-body">
												...
												<div class="row mb-3">
													...
													<div class="col-sm-9">
														...
														value= "<?php  echo $user['addressline']?>"> 
													</div>
												</div>
												...
												<div class="row mb-3">
													...
													<div class="col-sm-9">
														...
														value= "<?php  echo $user['postalcode']?>"> 
													</div>
												</div>
												...
												<div class="row mb-3">
													<div class="col-sm-3"></div>
														<div class="col-sm-9">
															<a href="page9.php"> <input type="submit" value="Save Changes" name="savebutton"></a>
														</div>
												</div>
									 </div>
								</form>
